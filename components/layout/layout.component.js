...
var NbLayoutHeaderComponent = /** @class */ (function () {
    ...
    NbLayoutHeaderComponent.decorators = [
        { type: Component, args: [{
                    ...
                    template: "\n    <nav [class.fixed]=\"fixedValue\" style=\"background-color:#008aff\">\n      <ng-content></ng-content>\n    </nav>\n  ",
                },] },
    ];
    /** @nocollapse */
...
var NbLayoutComponent = /** @class */ (function () {
    function NbLayoutComponent(themeService, spinnerService, componentFactoryResolver, elementRef, renderer, router, platformId, document) {
        var _this = this;
